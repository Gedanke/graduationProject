...
original_path = "../data/originalDataSet/car/car.txt"
separator = " "
attribute_name = [
...
csv_path = "../data/originalDataSet/car/car.csv"
attribute_dict_ = {
    "buying": 0, "maint": 0, "doors": 0, "persons": 0, "lug_boot": 0, "safety": 0, "Label": -1
}
attribute_dict = {
    "buying": 1, "maint": 1, "doors": 1, "persons": 1, "lug_boot": 1, "safety": 1, "Label": -1
}
remove_rate = 0.9

data_path_supervised = "../data/processedDataSet/car/car_supervised.csv"
data_path_unSupervised = "../data/processedDataSet/car/car_unSupervised.csv"
...
def fun2():
    ...
    :return:
    """
    d = DealData(csv_path, attribute_dict_, remove_rate)
...
sample = 0.2
final_path_supervised = "../data/processedDataSet/car/kMeans/car_supervised.csv"
final_path_unSupervised = "../data/processedDataSet/car/kMeans/car_unSupervised.csv"
