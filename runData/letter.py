...
original_path = "../data/originalDataSet/letter/letter-recognition.txt"
separator = " "
attribute_name = [
...
csv_path = "../data/originalDataSet/letter/letter.csv"
attribute_dict = {
...
data_path_supervised = "../data/processedDataSet/letter/letter_supervised.csv"
data_path_unSupervised = "../data/processedDataSet/letter/letter_unSupervised.csv"
